...
export const aiService = {
  generateMessage: (data: MessageGenerationRequest) =>
    client.post<MessageGenerationResponse>('/ai/generate', data),
  ...
  getRecommendations: (data: CampaignAdvisorRequest) =>
    client.post<CampaignAdvisorResponse>('/ai/recommendations', data),
  ...
  getUsageStats: () => client.get<AIUsageStats>('/ai/usage'),
